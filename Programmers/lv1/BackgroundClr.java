 ...
 * 나중에 다시 코드를 보면서 공부하려고 작성한 코드를
 * 컴퓨터 바탕화면에 아무 위치에나 저장해 둡니다.
 *
 ...
 * 파일들은 바탕화면의 격자칸에 위치하고 바탕화면의
 * 격자점들은 바탕화면의 가장 왼쪽 위를 (0, 0)으로 시작해
 * (세로 좌표, 가로 좌표)로 표현합니다. 빈칸은 ".",
 * 파일이 있는 칸은 "#"의 값을 가집니다.
 ...
 * 마우스 왼쪽 버튼으로 클릭한 상태로 격자점 E(rdx, rdy)
 * 로 이동한 뒤 마우스 왼쪽 버튼을 떼는 행동입니다.
...
public class BackgroundClr {
    ...
    public void solution(int i){
        switch (i){
            case 1:solution(this.wallpaper1); break;
            case 2:solution(this.wallpaper2); break;
            case 3:solution(this.wallpaper3); break;
            case 4:solution(this.wallpaper4); break;
        }
    };
}
